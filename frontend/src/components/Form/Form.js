...
function Form({title, buttonName, question, linkName, children, to, handleSubmit, handleChange, isValid, errors, textErrorApiRegister, textErrorApiLogin, isValidEmail, errorSumbit}) 
    {
